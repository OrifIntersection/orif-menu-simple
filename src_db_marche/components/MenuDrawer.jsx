      ...
      <div className={`menu-drawer ${isOpen ? "open" : ""}`}>
        ...
        <div className="drawer-content">
          ...
          <div className="drawer-section">
            ...
            {/* Pages principales */}
            <button className="drawer-action-item" onClick={() => handleNavAction(() => navigate('/import-local-menu'))}>
              <span className="action-icon">📥</span>
              <span className="action-label">Import Excel local</span>
            </button>
                ...
                <>
                  ...
                  {passedMenus.length > 0 && (
                    <>
                      ...
                      {passedMenus.map((menu) => (
                        <button
                          key={menu.id || `${menu.year}-${menu.weekNum}`}
                          className="drawer-menu-item"
                          onClick={() => handleMenuClick(menu.id)}
                        >
                          <div className="menu-item-label">{menu.weekLabel}</div>
                          <div className="menu-item-meta">
                            {(Array.isArray(menu.days) ? menu.days.length : 0)} jours • {(Array.isArray(menu.meals) ? menu.meals.length : 0)} repas
                          </div>
                        </button>
                      ))}
                    </>
                  ...
                  {currentMenu && (
                    <>
                      ...
                      <button
                        key={currentMenu.id || `${currentMenu.year}-${currentMenu.weekNum}`}
                      ...
                      >
                        ...
                        <div className="menu-item-meta">
                          {(Array.isArray(currentMenu.days) ? currentMenu.days.length : 0)} jours • {(Array.isArray(currentMenu.meals) ? currentMenu.meals.length : 0)} repas
                        </div>
                      </button>
                    </>
                  )}
