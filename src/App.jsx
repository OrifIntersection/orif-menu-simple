      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
          <select
            ...
            style={{ padding: '0.5rem 1.2rem', borderRadius: '6px', fontWeight: 'bold', minWidth: '120px', border: '1px solid #ccc', background: '#f5f5f5', color: '#333', cursor: 'pointer', fontSize: '1em' }}
          >
